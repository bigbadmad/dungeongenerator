...
import { generateStart, generateNext, advance, turnLeft, turnRight, opposite, resetIdCounter, buildRoomDescription, } from '../generator.js';
function makeState() {
    return {
...
describe('buildRoomDescription', () => {
    it('returns a non-empty string for all content types', () => {
        const types = ['empty', 'monster', 'monster_treasure', 'trap', 'trap_treasure', 'special', 'treasure'];
